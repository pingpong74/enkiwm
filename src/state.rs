...
impl Enki {
    pub fn new(event_loop: &mut EventLoop<Self>, display: Display<Self>) -> Self {
        ...
        // Some of them require us to implement traits on the Enki state,
    ...
    fn init_wayland_listener(display: Display<Enki>, event_loop: &mut EventLoop<Self>) -> OsString {
...
/// Data associated with a wayland client that connects to Enki.
